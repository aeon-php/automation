    ...
    public function parse(ChangesSource $changesSource) : Changes
    {
        ...
        switch (\strtolower($message->getType()->toString())) {
            ...
            case 'feat':
                return new Changes(
                    $changesSource,
                    new Changes\Change($changesSource, Changes\Type::added(), $message->getDescription()->toString()),
                );
            case 'updated':
            case 'changed':
            case 'change':
                return new Changes(
                    $changesSource,
                    new Changes\Change($changesSource, Changes\Type::changed(), $message->getDescription()->toString())
                );
            case 'cs':
            case 'fixed':
            case 'fix':
                return new Changes(
                    $changesSource,
                    new Changes\Change($changesSource, Changes\Type::fixed(), $message->getDescription()->toString())
                );
            case 'removed':
            case 'rm':
            case 'remove':
                return new Changes(
                    $changesSource,
                    new Changes\Change($changesSource, Changes\Type::removed(), $message->getDescription()->toString())
                );
            case 'dep':
            case 'deprecated':
            case 'deprecate':
                return new Changes(
                    $changesSource,
                    new Changes\Change($changesSource, Changes\Type::deprecated(), $message->getDescription()->toString())
                );
            case 'sec':
            case 'security':
                return new Changes(
                    $changesSource,
                    new Changes\Change($changesSource, Changes\Type::security(), $message->getDescription()->toString())
                );
