...
final class AeonApplication extends Application
{
    ...
    protected function getDefaultInputDefinition()
    {
        ...
        $definition->addOption(new InputOption('github-token', 'gt', InputOption::VALUE_REQUIRED, 'Github personal access token, be default taken from AEON_AUTOMATION_GH_TOKEN env variable'));
