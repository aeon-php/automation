...
{
    public function test_markdown_keep_a_changelog() : void
    {
...
MARKDOWN,
    ...
    public function test_markdown_classic() : void
    {
        $factory = new FormatterFactory(new Configuration(new NullLogger(), \getenv('AUTOMATION_ROOT_DIR'), []));
...
MARKDOWN,
    ...
    public function test_html_keep_a_changelog() : void
    {
        $factory = new FormatterFactory(new Configuration(new NullLogger(), \getenv('AUTOMATION_ROOT_DIR'), []));
...
HTML,
    ...
    public function test_html_classic() : void
    {
        $factory = new FormatterFactory(new Configuration(new NullLogger(), \getenv('AUTOMATION_ROOT_DIR'), []));
